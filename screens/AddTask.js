...
const AddTask = ({ navigation }) => {
    ...
    const myFunction = async () => {
        if (Object.keys(error).length === 0 && textValidated) {
            ...
            const ifData = await insertTasks(title, description, color)
            Toast.show({
                type: "success",
                text1: "Your task has been created"
            })
            setTimeout(() => {
                navigation.goBack()
            }, 2000);
    ...
    return (
        <View style={styles.container}>
            <View style={{ flexDirection: "row", alignItems: "center", }}>
                ...
                <Text style={{ textAlign: "center", fontSize: 18, flex: 1 }}>Add A New Task</Text>
            </View>
            ...
            <View style={styles.formContainer}>
                <View style={{ marginBottom: 20 }}>
                    <View style={{ ...styles.inputContainer, borderWidth: error.title ? 1 : 0 }}>
                        ...
                        <TextInput value={title} onChangeText={(e) => setTitle(e)} multiline={true} onKeyPress={() => setError({ ...error, title: null })} placeholder='Enter Your task Title' style={styles.input} />
                    </View>
                ...
                <View style={{ marginBottom: 20 }}>
                    ...
                    <View style={{ ...styles.inputContainer, borderWidth: error.description ? 1 : 0 }}>
                        ...
                        <TextInput value={description} onChangeText={(e) => setDescription(e)} on multiline={true} onKeyPress={() => setError({ ...error, description: null })} placeholder='Enter Your task Description' style={styles.input} />
                    </View>
                ...
                <TouchableOpacity style={styles.btn} onPress={uploadTasks}>
